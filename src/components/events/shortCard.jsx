...
function ShortCard({ eventType, eventOrigin, title, titleLargeEvent, titleActivity, user, capacity, capacityLargeEvent, format, startHours, endHours, startDay, startMounth, endDay, endMounth }) {  
  return (
     < >
